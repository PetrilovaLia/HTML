...
\begin{document}
	...
	\textbf{Rýchle vyhľadávanie webových stránok}
	...
	\textbf{Zhrnutie fyzickej štruktúry internetu}
	...
	Vždy, keď načítame webovú stránku alebo klikneme na tlačidlo na webovej stránke, signály putujú cez tieto podvodné a nadvodné drôty. Všetko, čo potrebujete, je IP adresa.	Drobné elektrické signály sa šíria rýchlosťou svetla cez oceány a pol sveta. Za pár milisekúnd si môžete zobraziť svoje obľúbené webové stránky. Taký úžasný je internet. \\
